Decision 001:
Phase 1A will predict the FIFA World Cup winner using only data available before the tournament starts.

Reason:
- Avoids data leakage.
- Simpler to validate.
- Serves as the foundation for the live model in Phase 1B.
